...
const requestLog = require('registry-mirror-common/handlers/request-log')
const errorLog = require('registry-mirror-common/handlers/error-log')
const favicon = require('registry-mirror-common/handlers/favicon')
